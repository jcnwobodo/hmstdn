                ...
                <fieldset class="full-margin-bottom">
                    ...
                    <div class="form-group form-group-sm">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input name="contact-phone" id="contact-phone" type="tel" maxlength="11" class="form-control" placeholder="0801231230" value="<?= isset($fields['contact-phone']) ? $fields['contact-phone'] : ''; ?>" required/>
                            </div>
                        </div>
                    </div>
